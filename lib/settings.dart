/********************************************************************/
/* This is the Settings page and currently only has the Avatar view */ 
/* and logout function.                                             */
/********************************************************************/
import 'dart:async';
import 'dart:io';
...
import 'package:firebase_login/colors.dart';
...
class SettingsScreenState extends State<SettingsScreen> {
  ...
  final FocusNode focusNodeNumber = new FocusNode();
  ...
  void readLocal() async {
    ...
    controllerNumber = new TextEditingController(text: number);
      ...
      if (value.error == null) {
        ...
        storageTaskSnapshot.ref.getDownloadURL().then((downloadUrl) {
          ...
          Firestore.instance
              .collection('users')
              .document(id)
              .updateData({'name': name, 'number': number, 'aboutMe': aboutMe, 'photoUrl': photoUrl}).then((data) async {
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Theme(
                      ...
                      child: TextField(
                        decoration: InputDecoration(
                          hintText: 'Wealth. Friendship. Love',
